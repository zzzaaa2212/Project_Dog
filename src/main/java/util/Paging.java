...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				...
				//색상변경은 font태그에서 ↓↓
				sb.append(");'>&nbsp<font color='black'>");
				sb.append(i);
				sb.append("</a></font>");
			}
		}// end for
...
//---------------------------------------------------------------------------------------------------------------------	    
	...
	// getPaging의 오버로드 메서드
	public static String _getPaging(String pageURL,int nowPage, int rowTotal, String search_param, int blockList, int blockPage){
